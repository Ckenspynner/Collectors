...
class CollectorFormWidget extends StatefulWidget {
  const CollectorFormWidget({Key? key}) : super(key: key);

  @override
  _CollectorFormWidgetState createState() => _CollectorFormWidgetState();
}

class _CollectorFormWidgetState extends State<CollectorFormWidget> {
                          ...
                          onTap: () {
                            ...
                            if (_formKey.currentState!.validate()) {
                              ...
                              final licensedCollector = LicensedCollectorModel(
                                  ...
                                  email: 'CA${controller.controllerEmail.text.trim()}'.toLowerCase(),
                                  ...
                                  license: 'CA${controller.controllerLicense.text.trim()}'.toUpperCase(),
                                  supervisorIdentity: emailAccount?.trim(),
                                  phoneNumber: controller.controllerPhoneNumber.text.trim()
                              );

                              //Register and Authenticate Users
                              AddRegisteredCollectorController.instance.createLicensedCollectorAgents(licensedCollector);
                            }
                          },
                        ),
                      ],
