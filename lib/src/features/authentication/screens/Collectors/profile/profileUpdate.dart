...
class ProfileDetailsUpdate extends StatefulWidget {
  ...
  @override
  _ProfileDetailsUpdateState createState() => _ProfileDetailsUpdateState();
}

class _ProfileDetailsUpdateState extends State<ProfileDetailsUpdate> {
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        initialValue: widget.subCountry,
                      ...
                      GestureDetector(
                        ...
                        onTap: () {
                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            //     username: controller.controllerUsername.text.trim(),
                            //     email: controller.controllerEmail.text.trim(),
                            //     county: controller.controllerCounty.text.trim(),
                            //     subCountry: controller.controllerSubCountry.text.trim(),
                            //     ward: controller.controllerWard.text.trim(),
                            //     license: 'CA${controller.controllerLicense.text.trim()}',
                            //     phoneNumber: controller.controllerPhoneNumber.text.trim()
                            // );

                            //Register and Authenticate Users
                            // AddRegisteredCollectorController.instance
                            //     .createLicensedCollectorAgents(
                            //         licensedCollector);
                          }
                        },
                      ),
