...
class GeneralCollector extends StatefulWidget {
  ...
  final String? collectorLicense;

  const GeneralCollector(
      {Key? key,
      this.restorationId,
      required this.backNav,
      this.collectorLicense,
...
class _GeneralCollectorState extends State<GeneralCollector>
  ...
  //   {"SourceName": "HSE01", "CurrentDate": currentDate, "Wet": 29, "Dry": 9},
  //   {"SourceName": "HSE02", "CurrentDate": currentDate1, "Wet": 40, "Dry": 20},
  //   {"SourceName": "HSE03", "CurrentDate": currentDate2, "Wet": 5, "Dry": 2},
  //   {"SourceName": "HSE04", "CurrentDate": currentDate, "Wet": 35, "Dry": 25},
  //   {"SourceName": "HSE05", "CurrentDate": currentDate1, "Wet": 21, "Dry": 29},
  //   {"SourceName": "HSE06", "CurrentDate": currentDate2, "Wet": 55, "Dry": 29},
  //   {"SourceName": "HSE07", "CurrentDate": currentDate, "Wet": 30, "Dry": 21},
  //   {"SourceName": "HSE08", "CurrentDate": currentDate1, "Wet": 14, "Dry": 39},
  //   {"SourceName": "HSE09", "CurrentDate": currentDate2, "Wet": 100, "Dry": 29},
  //   {"SourceName": "HSE10", "CurrentDate": currentDate, "Wet": 32, "Dry": 29},
  // ];

  List<Map<String, dynamic>> _allUsers = [];

  var splitName, SupervisorIdentity, UserAcountName;
...
//barcode scanner flutter ant
  ...
  Widget build(BuildContext context) {
    ...
    var splitUserName = widget.collectorName.split(" ");
                                    ...
                                    if (snapshot.connectionState ==
                                      ...
                                      if (snapshot.hasData) {
                                        LicensedCollectorModel
                                            licensedCollectorAgentData =
                                            snapshot.data
                                                as LicensedCollectorModel;
                                        splitName = licensedCollectorAgentData
                                            .username
                                            .split(" ");
                                        SupervisorIdentity =
                                            licensedCollectorAgentData
                                        ...
                                        //print(licensedCollectorAgentData.supervisorIdentity);
                                        //return Center(child: Text(licensedCollectorAgentData.username));
                                        return Column(
                                          crossAxisAlignment:
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Visibility(
                                    ...
                                    child: QrImageView(
                                      data:
                                      '${widget.collectorLicense},W$wettotal,D$drytotal,QR@KMFRI',
                                          //'Collector: ${widget.collectorName}, Wet: $wettotal, Dry: $drytotal, Date: $currentDate, QR@KMFRI',
                          ...
                          children: <Widget>[
                            ...
                            CheckboxListTile(
                              ...
                              contentPadding: const EdgeInsets.only(
                                  top: 5, right: 7, left: 15, bottom: 5),
                                ...
                                onPressed: () {
                                  ...
                                  if (valueHouse != '') {
                                    ...
                                    final scannerData = DataScannerModel(
                                      ...
                                      enumerator:
                                          '${widget.backNav == true ? 'You' : UserAcountName.trim()}',
                                      sourceName: valueHouse.trim(),
                                      segregation: _visibleWetDryOnList == true
                                          ? 'Segregated'
                                          : 'Not Segregated'.trim(),
                                      wet: _visibleWetDryOnList == true
                                          ? weightWetWaste.trim()
                                          : '0',
                                      dry: _visibleWetDryOnList == true
                                          ? weightDryWaste.trim()
                                          : '0',
                                      supervisorIdentity:
                                          '${widget.backNav == true ? emailAccount : SupervisorIdentity}',
                                      enumeratorEmail: emailAccount?.trim(),
                                    );

                                    //Store Collected Data
                                    DataScannerController.instance
                                        .storeScannedData(scannerData);
...
// sums[item["productName"]] = (sums[item["productName"]]! +
// int.parse(item["NumberOfItems"]))!;
// } else {
// sums[item["productName"]] =
// int.parse(item["NumberOfItems"]);
// }
// }
//
// List sumlist = [];
// sums.forEach((key, value) => sumlist.add(
...
// List Obj = [{1,2},{3,8}];
// var orderlist1 = {"productName": doc["CurrentDate"], "NumberOfItems": "${double.parse(doc["Wet"]).round() + double.parse(doc["Dry"]).round()}"};
//
// Obj.add(jsonEncode(orderlist1));
// //print('${doc["Enumerator"]} , ${doc["CurrentDate"]} , ${doc["Wet"]} , ${doc["Dry"]} , ${doc["SourceName"]} , ${doc["SupervisorIdentity"]}');// make sure you create the variable sumTotal somewhere
//
...
// doc["CurrentDate"],
// //doc["SourceName"],
// double.parse(doc["Wet"]) + double.parse(doc["Dry"]),
// //doc["Dry"],
// //doc["SupervisorIdentity"]
// }];

//print(collectArrayTray);
