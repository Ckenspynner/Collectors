...
bool _visible = true;
var option = "Today's";
String stationName = 'Kongowea Station';
List<Map<String, dynamic>> results = [];

class GeneralStation extends StatefulWidget {
  final bool backNav;

  const GeneralStation({Key? key, this.restorationId, required this.backNav})
      : super(key: key);
  final String? restorationId;

  @override
  State<GeneralStation> createState() => _GeneralStationState();
}

class _GeneralStationState extends State<GeneralStation> with RestorationMixin {
  ...
  var splitName, SupervisorIdentity, UserAcountName, UserStationName;
        ...
        if (_scanBarcode.contains(substring)) {
          ...
          if (split.length > 4) {
            ...
            if (values[0]?.substring(0, 2) == 'LA') {
              ...
              valueCollector = '${values[0]}';
              weightWetWaste = '${values[1]}'.substring(
                1,
              );
              weightDryWaste = '${values[2]}'.substring(
                1,
              );
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
                  ...
                  child: SizedBox(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          FutureBuilder(
                            future: controller.getStationCollectorData(),
                            builder: (BuildContext context,
                                AsyncSnapshot<dynamic> snapshot) {
                              if (snapshot.connectionState ==
                                  ConnectionState.done) {
                                if (snapshot.hasData) {
                                  TruckCollectorModel stationCollectorData =
                                      snapshot.data as TruckCollectorModel;
                                  splitName =
                                      stationCollectorData.oparator.split(" ");
                                  // SupervisorIdentity =
                                  //     stationCollectorData
                                  //         .supervisorIdentity;
                                  UserAcountName =
                                      stationCollectorData.oparator;
                                  UserStationName = stationCollectorData.model;
                    ...
                    child: SizedBox(
                      ...
                      child: FutureBuilder(
                        future: FirebaseFirestore.instance
                            .collection('StationScannerCollections')
                            .where("CurrentDate", isEqualTo: currentDate)
                            .where("EnumeratorEmail", isEqualTo: emailAccount)
                            .get(),
                        builder: (BuildContext context,
                            AsyncSnapshot<QuerySnapshot> snapshot) {
                          if (snapshot.hasError) {
                            ...
                            return Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  QrImageView(
                                    data: //${widget.collectorName}
                                        'SA$UserStationName,W$wettotal,D$drytotal,QR@KMFRI',
                                          ...
                                          (index) => ListTile(
                                            leading: CircleAvatar(
                                              ...
                                              child: const Text(
                                                ...
                                                //_foundUsers[index]["SourceName"].substring(3),
                                                'C',
                                                style: TextStyle(
                                                    color: Colors.white,
              ...
              //             QrImageView(
              //               data:
              //                   'Name: $stationName, Wet: $wettotal, Dry: $drytotal, Date: $currentDate, QR@KMFRI',
              //               version: QrVersions.auto,
              //               size: 300 * fem,
              //               backgroundColor: Colors.white,
              //               //data: '$_toggleQR',
                                ...
                                onPressed: () {
                                  ...
                                  if (valueCollector != '') {
                                    ...
                                    DataScannerController.instance
                                        .storeStationScannedData(scannerData);
